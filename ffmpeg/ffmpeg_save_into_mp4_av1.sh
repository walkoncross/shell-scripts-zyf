...
# ffmpeg -hide_banner -i $input -pix_fmt yuv420p -vcodec libaom-av1 -preset fast -tune film $output
# ffmpeg -hide_banner -i $input -pix_fmt yuv420p -vcodec libaom-av1 -tune film $output
