...
# ffmpeg -i $input -pix_fmt yuv420p -vcodec libx264 -preset fast -tune film $output
# ffmpeg -i $input -pix_fmt yuv420p -vcodec libx264 -tune film $output
ffmpeg -i $input -pix_fmt yuv420p -vcodec libx264 -preset fast $output
