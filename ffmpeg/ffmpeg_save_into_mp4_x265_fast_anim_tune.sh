...
# ffmpeg -hide_banner -i $input -pix_fmt yuv420p -vcodec libx265 -preset fast -tune animation $output
# ffmpeg -hide_banner -i $input -pix_fmt yuv420p -vcodec libx265 -tune animation $output
ffmpeg -hide_banner -i $input -pix_fmt yuv420p -vcodec libx265 -preset fast -tune animation $output
